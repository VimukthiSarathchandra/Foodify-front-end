    ...
    <>
      <div className="md:flex mt-10">
        ...
        <div className="md:w-1/2 md:pl-10 m-10 space-y-5 ">
          ...
          <h1 className="md:text-6xl text-4xl font-bold">Peerfect Foods </h1>
          <h1 className="md:text-6xl text-4xl font-bold text-[#FE724C]">Better Live </h1>
        ...
        <div className="md:w-1/2">
          <img src="/assets/images/hero-grid.png" alt="Hero Grid 2" />
        </div>
      </div>
    </>
  );
