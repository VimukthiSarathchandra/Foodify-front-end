    ...
    <>
      <div className="flex flex-col space-y-5 mt-10 mb-15 px-4 md:px-10 lg:px-30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 justify-items-center lg:justify-items-stretch">
            <Card>
              <CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-center mt-2">
                  Every meal is prepared with carefully selected, farm-fresh
                  ingredients to keep you healthy and satisfied.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
